...
void desenha_base_frontal() {
    ...
    float largura_base = LARGURA_ESCADA + 6.0f; 
...
void desenha_escada() {
    ...
    for (int i = 0; i < degraus; ++i) {
        ...
        glNormal3f(0.0f, 1.0f, 0.0f);
        glBegin(GL_QUADS);
            glVertex3f(-LARGURA_ESCADA/2, y_cima, z_tras);
            glVertex3f(LARGURA_ESCADA/2, y_cima, z_tras);
            glVertex3f(LARGURA_ESCADA/2, y_cima, z_frente);
            glVertex3f(-LARGURA_ESCADA/2, y_cima, z_frente);
        glEnd();
        ...
        glNormal3f(0.0f, 0.0f, -1.0f);
        glBegin(GL_QUADS);
            glVertex3f(-LARGURA_ESCADA/2, y_baixo, z_frente);
            glVertex3f(LARGURA_ESCADA/2, y_baixo, z_frente);
            glVertex3f(LARGURA_ESCADA/2, y_cima, z_frente);
            glVertex3f(-LARGURA_ESCADA/2, y_cima, z_frente);
        glEnd();
        ...
        glNormal3f(-1.0f, 0.0f, 0.0f);
        glBegin(GL_QUADS);
            glVertex3f(-LARGURA_ESCADA/2, y_baixo, z_tras);
            glVertex3f(-LARGURA_ESCADA/2, y_baixo, z_frente);
            glVertex3f(-LARGURA_ESCADA/2, y_cima, z_frente);
            glVertex3f(-LARGURA_ESCADA/2, y_cima, z_tras);
        glEnd();
